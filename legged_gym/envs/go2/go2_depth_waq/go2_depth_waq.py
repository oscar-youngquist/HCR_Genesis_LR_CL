...
class Go2Depth(LeggedRobotDreamwaq):
    ...
    def _resample_sensor_latency_if_needed(self):
        ...
        resample_mask = (self.episode_length_buf % int(resampling_time / self.dt)) == 0
    ...
    def _get_forward_depth_obs(self):
        if not self.depth_sensor_obs_refreshed:
            ...
            delay_refresh_mask = (self.episode_length_buf % int(self.cfg.sensor.depth_camera_config.refresh_duration / self.dt)) == 0
